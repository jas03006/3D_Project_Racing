...
namespace EzySlice {
    ...
    public sealed class SlicedHull {
        ...
        public GameObject CreateUpperHull(GameObject original, GameObject Parent = null) {
            return CreateUpperHull(original, null, Parent);
        }
        ...
        public GameObject CreateUpperHull(GameObject original, Material crossSectionMat,GameObject Parent=null) {
            ...
            if (newObject != null) {
                if (Parent != null) newObject.transform.SetParent(Parent.transform);
        ...
        public GameObject CreateLowerHull(GameObject original, GameObject Parent = null) {
            return CreateLowerHull(original, null, Parent);
        }
